...
echo "   GET /api/hotels      - Liste tous les hotels"
echo "   GET /api/reservations - Liste toutes les réservations"
echo "   GET /api/distance    - Liste toutes les distances"
echo "   GET /api/lieu        - Liste tous les lieux"
echo "   GET /api/carburant   - Liste tous les carburants"
echo "   GET /api/vehicule    - Liste tous les véhicules"
